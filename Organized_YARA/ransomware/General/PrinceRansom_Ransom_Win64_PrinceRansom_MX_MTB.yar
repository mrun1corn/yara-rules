...
rule Ransom_Win64_PrinceRansom_MX_MTB{
	meta:
		description = "Ransom:Win64/PrinceRansom.MX!MTB,SIGNATURE_TYPE_PEHSTR,04 00 04 00 05 00 00 "
	...
	strings :
		...
		$a_01_4 = {43 59 42 33 52 20 4c 30 43 4b 33 52 20 52 41 4e 53 4f 4d 57 41 52 45 } //1 CYB3R L0CK3R RANSOMWARE
	condition:
