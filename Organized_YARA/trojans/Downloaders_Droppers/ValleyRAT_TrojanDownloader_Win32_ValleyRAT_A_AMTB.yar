...
rule TrojanDownloader_Win32_ValleyRAT_A_AMTB{
	...
	strings :
		$a_03_0 = {68 74 74 70 [0-01] 3a 2f 2f 31 31 31 32 2e 36 38 38 36 30 38 2e 78 79 7a 2f 77 62 2f 6d 32 2e 74 78 74 } //3
		...
		$a_80_2 = {44 6f 77 6e 6c 6f 61 64 69 6e 67 20 62 69 6e 61 72 79 20 66 72 6f 6d 3a } //Downloading binary from:  1
	condition:
