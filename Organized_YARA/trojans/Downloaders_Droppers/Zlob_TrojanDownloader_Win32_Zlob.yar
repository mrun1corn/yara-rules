...
rule TrojanDownloader_Win32_Zlob_2{
	...
	strings :
		...
		$a_02_6 = {61 6e 61 6c [0-0a] 6d 6f 6e 73 74 65 72 73 2e 63 6f 6d } //10
...
rule TrojanDownloader_Win32_Zlob_4{
	...
	strings :
		...
		$a_02_3 = {56 68 04 01 00 00 6a 00 be ?? ?? ?? ?? 56 e8 ?? ?? ?? ?? ff 74 24 14 e8 ?? ?? ?? ?? 83 c4 10 48 78 1a 8b 4c 24 08 2b ce 8a 94 01 ?? ?? ?? ?? 32 54 24 0c 48 88 90 90 ?? ?? ?? ?? 79 ec 8b c6 5e c3 } //2
		$a_02_4 = {59 59 68 04 01 00 00 8d 44 24 14 50 6a ff 68 ?? 00 00 00 68 ?? ?? ?? ?? e8 ?? ?? ?? ?? 59 59 } //1
	condition:
...
rule TrojanDownloader_Win32_Zlob_8{
	...
	strings :
		...
		$a_02_10 = {2f 63 20 64 65 6c [0-05] 25 73 [0-05] 3e 3e [0-05] 6e 75 6c 6c 00 } //10
		$a_02_11 = {6a 00 6a 04 6a 02 6a 00 6a 01 68 00 00 00 40 68 ?? ?? 40 00 e8 ?? ?? ?? ?? 83 f8 ff 75 0c } //100
