...
rule Trojan_Win32_Amadey_Z{
	meta:
		description = "Trojan:Win32/Amadey.Z,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 07 00 00 "
		
	strings :
		$a_03_0 = {cc 6a 20 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 59 c3 cc cc cc 6a 20 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 59 c3 cc cc cc 6a 06 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 59 c3 cc cc cc 6a 20 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 } //1
		$a_03_1 = {cc 6a 44 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 59 c3 cc cc cc 6a 5c 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 59 c3 cc cc cc 6a 0c 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 } //1
		$a_03_2 = {cc 6a 50 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 59 c3 cc cc cc 6a 40 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 59 c3 cc cc cc 6a 0c 68 ?? ?? ?? 00 b9 ?? ?? ?? 00 e8 } //1
