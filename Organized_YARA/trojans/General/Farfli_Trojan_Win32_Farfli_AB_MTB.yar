...
rule Trojan_Win32_Farfli_AB_MTB{
	...
	strings :
		$a_01_0 = {bb e9 7e f3 64 48 09 57 56 53 ff d0 08 0c e8 15 ff 00 bb db fb 5c 82 b0 4e 0f 24 0a 4c 33 89 45 af b9 dd } //2
	condition:
		((#a_01_0  & 1)*2) >=2
...
rule Trojan_Win32_Farfli_AB_MTB_2{
	...
	strings :
		$a_03_0 = {55 8b ec 6a ff 68 2a 2c 0a 00 68 38 ?? 0d 00 64 a1 00 00 00 00 50 64 89 25 00 00 00 00 58 64 a3 00 00 00 00 58 58 58 58 8b e8 b8 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Farfli_AB_MTB_4{
	meta:
