...
rule Trojan_Win32_OffLoader_AMNA_MTB{
	meta:
		description = "Trojan:Win32/OffLoader.AMNA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 05 00 00 "
		
	strings :
		$a_80_0 = {3a 2f 2f 70 6c 61 6e 65 77 6f 6f 6c 2e 69 63 75 2f 75 6e 6b 2e 70 68 70 3f } //://planewool.icu/unk.php?  4
