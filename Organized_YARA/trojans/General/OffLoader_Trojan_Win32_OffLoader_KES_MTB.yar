...
rule Trojan_Win32_OffLoader_KES_MTB{
	...
	strings :
		$a_80_0 = {3a 2f 2f 73 75 69 74 6d 65 6d 6f 72 79 2e 69 6e 66 6f 2f 71 6f 72 74 2e 70 68 70 3f } //://suitmemory.info/qort.php?  4
		$a_80_1 = {3a 2f 2f 61 64 64 69 74 69 6f 6e 68 79 64 72 61 6e 74 2e 78 79 7a 2f 71 6f 72 74 73 2e 70 68 70 3f } //://additionhydrant.xyz/qorts.php?  4
