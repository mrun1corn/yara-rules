...
rule Trojan_Win32_OffLoader_LDM_MTB{
	...
	strings :
		$a_80_0 = {3a 2f 2f 72 65 63 65 69 70 74 63 6c 61 73 73 2e 69 6e 66 6f 2f 67 72 79 6d 2e 70 68 70 3f } //://receiptclass.info/grym.php?  4
		$a_80_1 = {3a 2f 2f 62 6f 72 64 65 72 65 78 70 65 72 69 65 6e 63 65 2e 78 79 7a 2f 67 72 79 6d 73 2e 70 68 70 3f } //://borderexperience.xyz/gryms.php?  4
