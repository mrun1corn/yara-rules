...
rule Trojan_Win32_Oyster_YAC_MTB{
	meta:
		description = "Trojan:Win32/Oyster.YAC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 04 00 00 "
		
	strings :
		$a_01_0 = {49 00 54 00 72 00 6b 00 66 00 53 00 61 00 56 00 2d 00 34 00 63 00 37 00 4b 00 77 00 64 00 66 00 6e 00 43 00 2d 00 44 00 73 00 31 00 36 00 35 00 58 00 55 00 34 00 43 00 2d 00 6c 00 48 00 36 00 52 00 39 00 70 00 6b 00 31 00 } //2 ITrkfSaV-4c7KwdfnC-Ds165XU4C-lH6R9pk1
