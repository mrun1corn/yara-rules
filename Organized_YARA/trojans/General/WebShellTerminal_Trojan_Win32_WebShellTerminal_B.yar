...
rule Trojan_Win32_WebShellTerminal_B{
	meta:
		description = "Trojan:Win32/WebShellTerminal.B,SIGNATURE_TYPE_CMDHSTR_EXT,0b 00 0b 00 08 00 00 "
	...
	strings :
		...
		$a_00_6 = {6d 00 73 00 65 00 64 00 67 00 65 00 77 00 65 00 62 00 76 00 69 00 65 00 77 00 32 00 2e 00 65 00 78 00 65 00 } //-50 msedgewebview2.exe
		$a_02_7 = {26 00 26 00 65 00 63 00 68 00 6f 00 [0-3c] 26 00 26 00 63 00 64 00 26 00 26 00 65 00 63 00 68 00 6f 00 [0-3c] 32 00 3e 00 26 00 31 00 } //-50
	condition:
		((#a_00_0  & 1)*10+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_02_3  & 1)*1+(#a_00_4  & 1)*-50+(#a_00_5  & 1)*-50+(#a_00_6  & 1)*-50+(#a_02_7  & 1)*-50) >=11
