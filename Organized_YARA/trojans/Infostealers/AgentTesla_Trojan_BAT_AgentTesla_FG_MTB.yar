...
rule Trojan_BAT_AgentTesla_FG_MTB{
	...
	strings :
		$a_01_0 = {03 04 73 84 00 00 0a 0a 73 6c 00 00 0a 0b 73 85 00 00 0a 0c 08 06 08 6f 86 00 00 0a 1e 5b 6f 87 00 00 0a 6f 88 00 00 0a 08 06 08 6f 89 00 00 0a 1e 5b 6f 87 00 00 0a 6f 8a 00 00 0a } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_FG_MTB_3{
	meta:
		description = "Trojan:BAT/AgentTesla.FG!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1a 00 1a 00 0a 00 00 "
		
	strings :
		$a_03_0 = {49 4d 47 5f [0-0f] 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //20
		$a_03_1 = {43 6f 6e 73 6f 6c 65 41 70 70 [0-0f] 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //20
		$a_03_2 = {43 6c 61 73 73 4c 69 62 72 61 72 79 [0-0f] 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //20
		$a_03_3 = {4f 72 64 65 72 [0-0f] 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //20
