...
rule Trojan_Win32_SusRegistryModification_A{
	meta:
		description = "Trojan:Win32/SusRegistryModification.A,SIGNATURE_TYPE_CMDHSTR_EXT,06 00 06 00 07 00 00 "
	...
	strings :
		...
		$a_00_6 = {34 00 62 00 37 00 39 00 66 00 66 00 61 00 62 00 2d 00 61 00 32 00 32 00 30 00 2d 00 34 00 65 00 64 00 35 00 2d 00 61 00 36 00 33 00 64 00 2d 00 31 00 66 00 31 00 61 00 39 00 30 00 34 00 35 00 31 00 31 00 33 00 74 00 } //-1 4b79ffab-a220-4ed5-a63d-1f1a9045113t
	condition:
		((#a_80_0  & 1)*1+(#a_80_1  & 1)*1+(#a_80_2  & 1)*1+(#a_80_3  & 1)*1+(#a_80_4  & 1)*1+(#a_00_5  & 1)*1+(#a_00_6  & 1)*-1) >=6
 
}
rule Trojan_Win32_SusRegistryModification_A_2{
	meta:
		description = "Trojan:Win32/SusRegistryModification.A,SIGNATURE_TYPE_CMDHSTR_EXT,03 00 03 00 03 00 00 "
	...
	strings :
		...
		$a_80_2 = {41 70 70 44 61 74 61 5c 4c 6f 63 61 6c 5c 54 65 6d 70 5c 54 31 31 31 32 2e 70 73 31 } //AppData\Local\Temp\T1112.ps1  1
	condition:
