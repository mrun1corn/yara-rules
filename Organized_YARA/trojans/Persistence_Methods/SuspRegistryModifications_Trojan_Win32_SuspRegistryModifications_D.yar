...
rule Trojan_Win32_SuspRegistryModifications_D{
	meta:
		description = "Trojan:Win32/SuspRegistryModifications.D,SIGNATURE_TYPE_CMDHSTR_EXT,07 00 07 00 07 00 00 "
	...
	condition:
		((#a_80_0  & 1)*1+(#a_80_1  & 1)*1+(#a_80_2  & 1)*1+(#a_80_3  & 1)*1+(#a_00_4  & 1)*1+(#a_00_5  & 1)*1+(#a_80_6  & 1)*1) >=7
