...
rule Trojan_BAT_DCRat_ND_MTB{
	...
	strings :
		$a_03_0 = {28 25 00 00 0a 28 ?? 00 00 06 6f ?? 00 00 0a 6f ?? 00 00 0a 0b 07 28 ?? 00 00 0a 00 07 } //2
		$a_03_1 = {72 8d 00 00 70 28 ?? 00 00 0a 00 20 ?? 0d 00 00 28 ?? 00 00 0a 00 28 } //3
	condition:
...
rule Trojan_BAT_DCRat_ND_MTB_2{
	...
	strings :
		$a_03_0 = {61 05 61 0a 7e ?? 00 00 04 0c 08 74 ?? 00 00 1b 25 06 93 0b 06 18 58 93 07 61 0b } //2
		$a_03_1 = {13 04 11 0a 75 ?? 00 00 1b 11 0c 93 13 05 11 0a 74 ?? 00 00 1b 11 0c 17 58 93 11 05 61 13 06 1f 0d } //1
	condition:
		((#a_03_0  & 1)*2+(#a_03_1  & 1)*1) >=3
 
}
rule Trojan_BAT_DCRat_ND_MTB_3{
	meta:
