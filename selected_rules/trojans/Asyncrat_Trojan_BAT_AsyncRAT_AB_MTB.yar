...
rule Trojan_BAT_AsyncRAT_AB_MTB{
	...
	strings :
		$a_03_0 = {02 07 08 6f ?? 00 00 0a 13 07 03 06 6f ?? 00 00 0a 59 13 08 11 08 16 3e ?? 00 00 00 06 12 07 28 ?? 00 00 0a 6f ?? 00 00 0a 11 08 17 59 13 08 11 08 16 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_BAT_AsyncRAT_AB_MTB_3{
	meta:
