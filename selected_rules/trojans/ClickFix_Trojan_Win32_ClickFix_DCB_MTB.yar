...
rule Trojan_Win32_ClickFix_DCB_MTB{
	meta:
		description = "Trojan:Win32/ClickFix.DCB!MTB,SIGNATURE_TYPE_CMDHSTR_EXT,ffffffa3 00 ffffffa3 00 06 00 00 "
	...
	strings :
		...
		$a_00_5 = {2e 00 6a 00 6f 00 69 00 6e 00 28 00 } //1 .join(
	condition:
