...
rule Trojan_BAT_FormBook_AFO_MTB_7{
	...
	strings :
		$a_03_0 = {19 5d 13 17 17 11 16 58 19 5d 13 18 18 11 16 58 19 5d 13 19 19 8d ?? 00 00 01 13 1a 11 1a 16 12 14 28 ?? 00 00 0a 9c 11 1a 17 12 14 28 ?? 00 00 0a 9c 11 1a 18 12 14 28 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AFO_MTB_8{
	...
	strings :
		$a_03_0 = {16 13 09 2b 19 00 06 7b ?? 01 00 04 11 24 11 09 91 6f ?? 01 00 0a 00 00 11 09 17 58 13 09 11 09 11 16 fe 04 13 25 } //2
		$a_01_1 = {44 00 6f 00 41 00 6e 00 43 00 61 00 4e 00 68 00 61 00 6e 00 } //1 DoAnCaNhan
	condition:
