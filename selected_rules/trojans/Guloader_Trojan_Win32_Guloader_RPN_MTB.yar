...
rule Trojan_Win32_Guloader_RPN_MTB_4{
	meta:
		description = "Trojan:Win32/Guloader.RPN!MTB,SIGNATURE_TYPE_PEHSTR,12 00 12 00 09 00 00 "
		
	strings :
		$a_01_0 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 6e 00 6f 00 6e 00 72 00 65 00 61 00 73 00 6f 00 6e 00 69 00 6e 00 67 00 5c 00 64 00 61 00 67 00 73 00 61 00 6b 00 74 00 75 00 65 00 6c 00 74 00 } //10 Software\nonreasoning\dagsaktuelt
		$a_01_1 = {42 00 69 00 6b 00 75 00 62 00 65 00 72 00 31 00 31 00 2e 00 63 00 6f 00 6d 00 } //1 Bikuber11.com
		$a_01_2 = {46 00 6f 00 72 00 6c 00 65 00 6d 00 73 00 2e 00 62 00 61 00 72 00 } //1 Forlems.bar
		$a_01_3 = {52 00 65 00 66 00 65 00 72 00 73 00 2e 00 69 00 6e 00 69 00 } //1 Refers.ini
		$a_01_4 = {52 00 65 00 6e 00 6f 00 77 00 6e 00 6c 00 65 00 73 00 73 00 2e 00 69 00 6e 00 69 00 } //1 Renownless.ini
		$a_01_5 = {53 00 75 00 6e 00 64 00 68 00 65 00 64 00 73 00 74 00 65 00 67 00 6e 00 65 00 6e 00 65 00 2e 00 74 00 78 00 74 00 } //1 Sundhedstegnene.txt
		$a_01_6 = {55 00 6e 00 63 00 68 00 61 00 72 00 61 00 63 00 74 00 65 00 72 00 69 00 7a 00 65 00 64 00 2e 00 69 00 6e 00 69 00 } //1 Uncharacterized.ini
		$a_01_7 = {73 00 6b 00 61 00 74 00 74 00 65 00 61 00 61 00 72 00 65 00 6e 00 65 00 2e 00 74 00 78 00 74 00 } //1 skatteaarene.txt
		$a_01_8 = {6e 00 73 00 69 00 73 00 2e 00 73 00 66 00 2e 00 6e 00 65 00 74 00 2f 00 4e 00 53 00 49 00 53 00 5f 00 45 00 72 00 72 00 6f 00 72 00 } //1 nsis.sf.net/NSIS_Error
	condition:
