...
rule Trojan_Win32_OffLoader_AMMA_MTB{
	meta:
		description = "Trojan:Win32/OffLoader.AMMA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 05 00 00 "
		
	strings :
		$a_80_0 = {3a 2f 2f 7a 69 70 70 65 72 77 6f 72 6b 2e 69 63 75 2f 72 69 64 2e 70 68 70 3f } //://zipperwork.icu/rid.php?  4
