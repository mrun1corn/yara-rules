...
rule Trojan_Win32_OffLoader_AMPA_MTB{
	meta:
		description = "Trojan:Win32/OffLoader.AMPA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 05 00 00 "
		
	strings :
		$a_80_0 = {3a 2f 2f 79 61 72 6e 77 6f 6f 6c 2e 78 79 7a 2f 67 72 75 6e 2e 70 68 70 3f } //://yarnwool.xyz/grun.php?  4
