...
rule Trojan_Win32_OffLoader_AQTA_MTB{
	meta:
		description = "Trojan:Win32/OffLoader.AQTA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 05 00 00 "
		
	strings :
		$a_80_0 = {3a 2f 2f 79 61 6d 68 6f 74 2e 69 63 75 2f 69 65 72 2e 70 68 70 3f } //://yamhot.icu/ier.php?  4
