...
rule Trojan_Win32_OffLoader_ATSA_MTB{
	meta:
		description = "Trojan:Win32/OffLoader.ATSA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 05 00 00 "
		
	strings :
		$a_80_0 = {3a 2f 2f 72 69 63 65 62 72 65 61 74 68 2e 69 63 75 2f 74 72 69 2e 70 68 70 3f } //://ricebreath.icu/tri.php?  4
