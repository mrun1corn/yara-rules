...
rule Trojan_Win32_OffLoader_SKIA_MTB{
	meta:
		description = "Trojan:Win32/OffLoader.SKIA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 05 00 00 "
		
	strings :
		$a_80_0 = {3a 2f 2f 76 65 69 6e 66 65 61 72 2e 63 66 64 2f 63 61 72 6f 2e 70 68 70 } //://veinfear.cfd/caro.php  4
