...
rule Trojan_Win32_OffLoader_SPEP_MTB{
	...
	strings :
		$a_01_0 = {6d 00 69 00 6e 00 65 00 69 00 63 00 69 00 63 00 6c 00 65 00 2e 00 69 00 6e 00 66 00 6f 00 2f 00 68 00 6d 00 6f 00 2e 00 70 00 68 00 70 00 } //4 mineicicle.info/hmo.php
