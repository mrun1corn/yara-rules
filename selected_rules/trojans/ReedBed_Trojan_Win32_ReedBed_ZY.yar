...
rule Trojan_Win32_ReedBed_ZY{
	meta:
		description = "Trojan:Win32/ReedBed.ZY,SIGNATURE_TYPE_CMDHSTR_EXT,67 00 67 00 04 00 00 "
	...
	strings :
		...
		$a_00_3 = {20 00 2f 00 74 00 20 00 52 00 45 00 47 00 5f 00 53 00 5a 00 20 00 2f 00 66 00 } //1  /t REG_SZ /f
	condition:
