...
rule Trojan_Win32_RemcosRAT_A_MTB_2{
	...
	strings :
		...
		$a_00_1 = {72 00 65 00 66 00 6c 00 65 00 63 00 74 00 69 00 6f 00 6e 00 2e 00 61 00 73 00 73 00 65 00 6d 00 62 00 6c 00 79 00 5d 00 3a 00 3a 00 6c 00 6f 00 61 00 64 00 28 00 24 00 } //10 reflection.assembly]::load($
