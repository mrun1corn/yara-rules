...
rule Trojan_Win32_SuspSettings_E{
	...
	strings :
		...
		$a_00_5 = {36 00 39 00 38 00 30 00 32 00 63 00 39 00 38 00 2d 00 32 00 63 00 6d 00 32 00 2d 00 34 00 61 00 31 00 37 00 2d 00 39 00 38 00 77 00 30 00 2d 00 33 00 61 00 39 00 32 00 32 00 30 00 61 00 64 00 30 00 31 00 35 00 37 00 } //-1 69802c98-2cm2-4a17-98w0-3a9220ad0157
	condition:
