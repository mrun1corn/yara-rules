...
rule Trojan_Win32_ValakSchtasks_MK{
	meta:
		description = "Trojan:Win32/ValakSchtasks.MK,SIGNATURE_TYPE_CMDHSTR_EXT,06 00 06 00 07 00 00 "
	...
	strings :
		...
		$a_00_6 = {61 00 34 00 35 00 33 00 65 00 38 00 38 00 31 00 2d 00 32 00 36 00 61 00 38 00 2d 00 34 00 39 00 37 00 33 00 2d 00 62 00 61 00 32 00 65 00 2d 00 37 00 36 00 32 00 36 00 39 00 65 00 39 00 30 00 31 00 64 00 30 00 61 00 } //-1 a453e881-26a8-4973-ba2e-76269e901d0a
	condition:
