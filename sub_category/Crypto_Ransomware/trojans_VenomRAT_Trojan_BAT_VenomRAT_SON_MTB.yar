...
rule Trojan_BAT_VenomRAT_SON_MTB{
	meta:
		description = "Trojan:BAT/VenomRAT.SON!MTB,SIGNATURE_TYPE_PEHSTR,0e 00 0e 00 05 00 00 "
		
	strings :
		$a_01_0 = {4d 00 65 00 73 00 68 00 45 00 6b 00 72 00 61 00 6e 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //10 MeshEkran.Properties.Resources
