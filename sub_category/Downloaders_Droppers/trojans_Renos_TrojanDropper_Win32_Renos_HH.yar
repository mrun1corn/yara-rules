...
rule TrojanDropper_Win32_Renos_HH{
	...
	strings :
		$a_03_0 = {1c 40 3d 00 01 00 00 72 f4 [0-10] 68 ff ff ?? ?? 68 ff ff } //5
		$a_03_1 = {40 00 68 ff ff ?? ?? 68 ff ff } //2
		$a_01_2 = {68 82 00 00 00 } //1
		$a_02_3 = {6a 02 57 6a fc 56 ff 15 ?? ?? ?? 00 } //1
		...
		$a_00_10 = {57 49 4e 49 4e 45 54 2e 44 4c 4c 00 } //1 䥗䥎䕎⹔䱄L
