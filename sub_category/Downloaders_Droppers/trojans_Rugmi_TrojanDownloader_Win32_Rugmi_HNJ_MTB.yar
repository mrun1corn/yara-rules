...
rule TrojanDownloader_Win32_Rugmi_HNJ_MTB{
	meta:
		description = "TrojanDownloader:Win32/Rugmi.HNJ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 "
	...
	strings :
		...
		$a_03_2 = {89 4d f4 ba 08 00 00 00 6b c2 00 8b 4d f4 8b 55 08 03 ?? 01 78 } //10
	condition:
		((#a_01_0  & 1)*1+(#a_03_1  & 1)*1+(#a_03_2  & 1)*10) >=12
