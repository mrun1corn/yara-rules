...
rule Trojan_BAT_Lokibot_ABL_MTB{
	...
	strings :
		$a_03_0 = {0a 16 0b 2b 14 00 06 07 06 07 91 07 28 ?? 00 00 06 61 d2 9c 00 07 17 58 0b 07 06 8e 69 fe 04 0c 08 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Lokibot_ABL_MTB_2{
	...
	strings :
		$a_03_0 = {16 0c 2b 1c 07 08 9a 03 28 ?? 00 00 06 0d 09 2c 05 16 2d e6 09 2a 08 1c 2c d9 17 25 2c 09 58 0c 15 2c e1 08 07 8e 69 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
 
}
rule Trojan_BAT_Lokibot_ABL_MTB_3{
	meta:
		description = "Trojan:BAT/Lokibot.ABL!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 "
