...
rule Trojan_Win32_LummaStealerClick_V_MTB{
	meta:
		description = "Trojan:Win32/LummaStealerClick.V!MTB,SIGNATURE_TYPE_CMDHSTR_EXT,06 00 06 00 06 00 00 "
	...
	strings :
		...
		$a_00_3 = {70 00 73 00 6f 00 62 00 6a 00 65 00 63 00 74 00 2e 00 6d 00 65 00 74 00 68 00 6f 00 64 00 73 00 } //1 psobject.methods
