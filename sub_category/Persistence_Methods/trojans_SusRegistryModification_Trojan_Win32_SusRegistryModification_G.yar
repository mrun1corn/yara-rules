...
rule Trojan_Win32_SusRegistryModification_G{
	meta:
		description = "Trojan:Win32/SusRegistryModification.G,SIGNATURE_TYPE_CMDHSTR_EXT,05 00 05 00 06 00 00 "
	...
	strings :
		...
		$a_00_5 = {39 00 39 00 31 00 61 00 61 00 35 00 38 00 64 00 2d 00 38 00 39 00 31 00 63 00 2d 00 34 00 35 00 64 00 36 00 2d 00 38 00 63 00 63 00 30 00 2d 00 35 00 33 00 65 00 64 00 64 00 33 00 61 00 66 00 37 00 39 00 32 00 64 00 } //-1 991aa58d-891c-45d6-8cc0-53edd3af792d
	condition:
