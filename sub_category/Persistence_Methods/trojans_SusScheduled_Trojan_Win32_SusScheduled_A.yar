...
rule Trojan_Win32_SusScheduled_A{
	meta:
		description = "Trojan:Win32/SusScheduled.A,SIGNATURE_TYPE_CMDHSTR_EXT,08 00 08 00 09 00 00 "
	...
	strings :
		...
		$a_00_8 = {39 00 34 00 35 00 33 00 65 00 38 00 38 00 31 00 2d 00 32 00 36 00 61 00 38 00 2d 00 34 00 39 00 37 00 33 00 2d 00 62 00 61 00 32 00 65 00 2d 00 37 00 36 00 32 00 36 00 39 00 65 00 39 00 30 00 31 00 64 00 30 00 78 00 } //-1 9453e881-26a8-4973-ba2e-76269e901d0x
	condition:
		((#a_80_0  & 1)*1+(#a_80_1  & 1)*1+(#a_80_2  & 1)*1+(#a_80_3  & 1)*1+(#a_80_4  & 1)*1+(#a_80_5  & 1)*1+(#a_80_6  & 1)*1+(#a_80_7  & 1)*1+(#a_00_8  & 1)*-1) >=8
