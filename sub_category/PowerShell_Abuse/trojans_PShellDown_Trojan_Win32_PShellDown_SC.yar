...
rule Trojan_Win32_PShellDown_SC{
	meta:
		description = "Trojan:Win32/PShellDown.SC,SIGNATURE_TYPE_CMDHSTR_EXT,1f 00 1f 00 0c 00 00 "
	...
	strings :
		...
		$a_80_11 = {68 74 74 70 3a 2f 2f 31 36 39 2e 32 35 34 2e } //http://169.254.  -100
	condition:
		((#a_80_0  & 1)*10+(#a_80_1  & 1)*10+(#a_80_2  & 1)*10+(#a_80_3  & 1)*20+(#a_80_4  & 1)*10+(#a_80_5  & 1)*1+(#a_80_6  & 1)*1+(#a_80_7  & 1)*1+(#a_80_8  & 1)*1+(#a_00_9  & 1)*-500+(#a_00_10  & 1)*-100+(#a_80_11  & 1)*-100) >=31
