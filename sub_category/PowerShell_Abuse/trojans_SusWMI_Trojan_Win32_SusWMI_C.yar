...
rule Trojan_Win32_SusWMI_C{
	meta:
		description = "Trojan:Win32/SusWMI.C,SIGNATURE_TYPE_CMDHSTR_EXT,02 00 02 00 0a 00 00 "
	...
	strings :
		...
		$a_00_9 = {36 00 39 00 38 00 30 00 32 00 63 00 39 00 38 00 2d 00 32 00 63 00 63 00 32 00 2d 00 34 00 61 00 31 00 37 00 2d 00 39 00 38 00 77 00 30 00 2d 00 33 00 61 00 39 00 32 00 32 00 30 00 61 00 64 00 30 00 31 00 35 00 37 00 } //-1 69802c98-2cc2-4a17-98w0-3a9220ad0157
	condition:
		((#a_80_0  & 1)*1+(#a_80_1  & 1)*1+(#a_80_2  & 1)*1+(#a_80_3  & 1)*1+(#a_80_4  & 1)*1+(#a_80_5  & 1)*1+(#a_80_6  & 1)*1+(#a_80_7  & 1)*1+(#a_80_8  & 1)*1+(#a_00_9  & 1)*-1) >=2
